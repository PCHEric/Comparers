...
namespace Nito.Comparers.Util
{
    ...
    internal abstract class EqualityComparerBase<T> : IFullEqualityComparer<T>
    {
        ...
        /// <inheritdoc />
        public bool Equals([AllowNull] T x, [AllowNull] T y) => EqualityComparerHelpers.ImplementEquals(x, y, SpecialNullHandling, DoEquals);

        /// <inheritdoc />
        public int GetHashCode([AllowNull] T obj) => EqualityComparerHelpers.ImplementGetHashCode(obj, SpecialNullHandling, DoGetHashCode);
    }
}
